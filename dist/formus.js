 ...
 */
  formus.provider('FormusContainer', function () {
    var log, helper, defaultConfig, container = {};
  ...
  formus.directive('formusField', [
    ...
    'FormusValidator',
    'FormusHelper',
    function ($injector, $http, $compile, $log, $templateCache, FormusLinker, FormusValidator, FormusHelper) {
      return {
        transclude: true,
        restrict: 'E',
        scope: { 'config': '=' },
 ...
 */
  formus.provider('FormusTemplates', function () {
    ...
    var load = function (templateUrl) {
      ...
      http.get(templateUrl, { cache: cache }).then(function (response) {
 ...
 */
  ...
  formus.directive('formusWrapper', [
    'FormusTemplates',
    'FormusLinker',
    '$timeout',
    function (FormusTemplates, FormusLinker, $timeout) {
      return {
        restrict: 'AE',
        transclude: true,
